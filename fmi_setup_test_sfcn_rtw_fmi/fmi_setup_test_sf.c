...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   *  Sum: '<Root>/Add2'
   */
  ((real32_T *)ssGetOutputPortSignal(S, 0))[0] = ((((real32_T)(*((const real32_T
    **)ssGetInputPortSignalPtrs(S, 0))[0] / *((const real32_T **)
    ssGetInputPortSignalPtrs(S, 1))[0]) + *((const real32_T **)
    ssGetInputPortSignalPtrs(S, 4))[0]) + *((const real32_T **)
    ssGetInputPortSignalPtrs(S, 1))[0]) + (*((const real32_T **)
    ssGetInputPortSignalPtrs(S, 2))[0] + *((const real32_T **)
