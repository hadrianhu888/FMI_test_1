  % Autogenerated file: Fri May 27 15:29:51 2022
...
codeInfo = codeIRInfoStruct.codeInfo;
  ...
  wr = coder.internal.writeDataInterfacesToCodeDescriptor("fmi_test_1",pwd) ;
  ...
  skippedParameters = [];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        func_Initialize_Prototype.HeaderFile = ['fmi_test_1', '.h'];
    func_Initialize_Prototype.SourceFile = ['fmi_test_1', '.c'];
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'fmi_test_1_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        func_OutputUpdate_Prototype.HeaderFile = ['fmi_test_1', '.h'];
    func_OutputUpdate_Prototype.SourceFile = ['fmi_test_1', '.c'];
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'fmi_test_1_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        func_Terminate_Prototype.HeaderFile = ['fmi_test_1', '.h'];
    func_Terminate_Prototype.SourceFile = ['fmi_test_1', '.c'];
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['fmi_test_1_terminate'];
